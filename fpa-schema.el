("root" do-not-export "FatturaElettronica"
 (("1" do-not-export "FatturaElettronicaHeader"
   (("1.1" do-not-export "DatiTrasmissione"
    ...
    ("1.2" do-not-export "CedentePrestatore"
     (("1.2.1" do-not-export "DatiAnagrafici"
       (("1.2.1.1" do-not-export "IdFiscaleIVA"
         (("1.2.1.1.1" do-not-export "IdPaese" nil)
          ("1.2.1.1.2" do-not-export "IdCodice" nil)))
        ("1.2.1.2" do-not-export "CodiceFiscale" nil)
        ("1.2.1.3" do-not-export "Anagrafica"
         (("1.2.1.3.1" do-not-export "Denominazione" nil)
          ("1.2.1.3.2" do-not-export "Nome" nil)
          ("1.2.1.3.3" do-not-export "Cognome" nil)
        ...
        ("1.2.1.8" do-not-export "RegimeFiscale" nil)))
      ("1.2.2" do-not-export "Sede"
       (("1.2.2.1" do-not-export "Indirizzo" nil)
        ("1.2.2.2" do-not-export "NumeroCivico" nil)
        ("1.2.2.3" do-not-export "CAP" nil)
        ("1.2.2.4" do-not-export "Comune" nil)
        ("1.2.2.5" do-not-export "Provincia" nil)
        ("1.2.2.6" do-not-export "Nazione" nil)))
    ...
    ("1.4" do-not-export "CessionarioCommittente"
     (("1.4.1" do-not-export "DatiAnagrafici"
       (("1.4.1.1" do-not-export "IdFiscaleIVA"
         (("1.4.1.1.1" do-not-export "IdPaese" nil)
          ("1.4.1.1.2" do-not-export "IdCodice" nil)))
        ("1.4.1.2" do-not-export "CodiceFiscale" nil)
        ("1.4.1.3" do-not-export "Anagrafica"
         (("1.4.1.3.1" do-not-export "Denominazione" nil)
          ("1.4.1.3.2" do-not-export "Nome" nil)
          ("1.4.1.3.3" do-not-export "Cognome" nil)
          ("1.4.1.3.4" do-not-export "Titolo" nil)
          ("1.4.1.3.5" do-not-export "CodEORI" nil)))))
      ("1.4.2" do-not-export "Sede"
       (("1.4.2.1" do-not-export "Indirizzo" nil)
        ("1.4.2.2" do-not-export "NumeroCivico" nil)
        ("1.4.2.3" do-not-export "CAP" nil)
        ("1.4.2.4" do-not-export "Comune" nil)
        ("1.4.2.5" do-not-export "Provincia" nil)
        ("1.4.2.6" do-not-export "Nazione" nil)))
  ...
  ("2" do-not-export "FatturaElettronicaBody"
   (("2.1" do-not-export "DatiGenerali"
     (("2.1.1" do-not-export "DatiGeneraliDocumento"
       (("2.1.1.1" do-not-export "TipoDocumento" nil)
        ("2.1.1.2" do-not-export "Divisa" nil)
        ("2.1.1.3" do-not-export "Data" nil)
        ("2.1.1.4" do-not-export "Numero" nil)
        ...
        ("2.1.1.9" do-not-export "ImportoTotaleDocumento" nil)
        ("2.1.1.10" do-not-export "Arrotondamento" nil)
        ("2.1.1.11" do-not-export "Causale" nil)
    ...
    ("2.2" do-not-export "DatiBeniServizi"
     (("2.2.1" do-not-export "DettaglioLinee"
       (("2.2.1.1" do-not-export "NumeroLinea" nil)
        ("2.2.1.2" do-not-export "TipoCessionePrestazione" nil)
        ("2.2.1.3" do-not-export "CodiceArticolo"
         (("2.2.1.3.1" do-not-export "CodiceTipo" nil)
          ("2.2.1.3.2" do-not-export "CodiceValore" nil)))
        ("2.2.1.4" do-not-export "Descrizione" nil)
        ("2.2.1.5" do-not-export "Quantita" nil)
        ("2.2.1.6" do-not-export "UnitaMisura" nil)
        ("2.2.1.7" do-not-export "DataInizioPeriodo" nil)
        ("2.2.1.8" do-not-export "DataFinePeriodo" nil)
        ("2.2.1.9" do-not-export "PrezzoUnitario" nil)
        ...
        ("2.2.1.11" do-not-export "PrezzoTotale" nil)
        ("2.2.1.12" do-not-export "AliquotaIVA" nil)
    ...
    ("2.4" do-not-export "DatiPagamento"
     (("2.4.1" do-not-export "CondizioniPagamento" nil)
      ("2.4.2" do-not-export "DettaglioPagamento"
       (("2.4.2.1" do-not-export "Beneficiario" nil)
        ("2.4.2.2" do-not-export "ModalitaPagamento" nil)
        ("2.4.2.3" do-not-export "DataRiferimentoTerminiPagamento" nil)
        ("2.4.2.4" do-not-export "GiorniTerminiPagamento" nil)
        ("2.4.2.5" do-not-export "DataScadenzaPagamento" nil)
        ("2.4.2.6" do-not-export "ImportoPagamento" nil)
